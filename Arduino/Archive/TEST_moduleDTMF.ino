...
/*   l'utilisation du module RTC DS1307, avec un arduino MEGA.		*/		// le brochage I2C se fait sur les broches SDA: 20(Mega) A4(Uno), SCL: 21(Mega) A5(Uno)
/*         						description							*/
/*         						description							*/
/* **************************************************************** */
